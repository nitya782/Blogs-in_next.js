        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 hover: transition-shadow duration-300">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-500">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                } text-white font-semibold py-3 px-6 rounded-lg  transition-all duration-200 transform hover:scale-[1.02] mt-2 disabled:opacity-70 disabled:hover:scale-100 flex items-center justify-center`}
              >
                {loading ? (
                  <>
